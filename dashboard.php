                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        ...
                        <div class="col-lg-6 col-5 text-right">
                            <button type="button" class="btn btn-sm btn-default" data-toggle="modal" data-target="#modal-upload-fp">
                                <i class="ni ni-single-02"></i>
                                <span>Foto Perfil</span>
                            </button>
                            <div class="modal fade" id="modal-upload-fp" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
                                <div class="modal-dialog modal- modal-dialog-centered modal-sm" role="document">
                                <div class="modal-content">
                                    <div class="modal-body p-0">
                                    <div class="card bg-secondary border-0 mb-0">
                                        <div class="card-header bg-transparent">
                                            <h3 class="mb-0 text-left">Suba su foto de perfil</h3>
                                        </div>
                                        <div class="card-body px-lg-5 py-lg-5">
                                            <form id="upload" method="POST" enctype="multipart/form-data"> 
                                                <div class="form-group mb-5">
                                                    <div class="custom-file">
                                                        <label class="custom-file-label text-left" for="foto">Foto de perfil</label>    
                                                        <input type="file" class="custom-file-input" name ="foto" id="foto" accept=".png, .jpeg, .jpg">
                                                    </div>
                                                </div>
                                                <div class="text-center">
                                                    <button id="btnUploadImg" type="button" class="btn btn-success">Enviar</button>
                                                </div>
                                            </form>
                                            </div>
                                    </div>
...
<script>
    ...
    $("#btnUploadImg").click(function(){
        ...
        if(files.length > 0 ){
            ...
            swal({
                title: "Error",
                text: "Seleccione una foto antes de enviar",
                type: "error"
            });
        }
    });
