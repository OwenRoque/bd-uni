...
<head>
  ...
  <!-- Argon CSS -->
  <link rel="stylesheet" href="argon.css?v=1.1.0" type="text/css">
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              <h1 class="text-white">Registra un nuevo Usuario</h1>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form">
                ...
                <div class="text-center">
                  <button id="btnAcceder" type="button" class="btn btn-primary mt-4">Registrar Cuenta</button>
                </div>
              </form>
            </div>
          </div>
